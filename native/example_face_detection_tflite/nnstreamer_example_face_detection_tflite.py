...
'res_face' updates face detection result to display in cairooverlay.
This example shows only the largest detected face in the video, 
while the other faces are covered with black rectangles.
