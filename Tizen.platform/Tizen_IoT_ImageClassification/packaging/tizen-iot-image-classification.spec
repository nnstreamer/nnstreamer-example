...
Name:		tizen-iot-image-classification
...
%description
Image classification sample app with Tizen IoT platform
...
%files
%manifest tizen-iot-image-classification.manifest
%defattr(-,root,root,-)
%{nnstexampledir}/*

%changelog
* Tue Jun 23 2020 Gichan Jang <gichan2.jang@samsung.com>
- create the Tizen IoT image classification smaple app
