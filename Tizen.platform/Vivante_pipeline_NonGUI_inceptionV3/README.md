...
```bash
$ vivante-inceptionv3-pipeline ${PATH_TO_JPEG}
# e.g. vivante-inceptionv3-pipeline /usr/share/vivante-inceptionv3-pipeline/sample_pizza_299x299.jpg
```

The result should be similar with below
```bash
root@localhost:~# vivante-inceptionv3-pipeline /usr/share/vivante-inceptionv3-pipeline/sample_pizza_299x299.jpg
...
[142] pipeline: filesrc location="/usr/share/vivante-inceptionv3-pipeline/sample_pizza_299x299.jpg" blocksize=-1 ! jpex
...
Create Neural Network: 20ms or 0us
...
I [vsi_nn_PrintNode:159](             NBG)node[0] [in: 1 ], [out: 0 ] [014edcb8]
