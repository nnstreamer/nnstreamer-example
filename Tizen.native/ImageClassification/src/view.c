...
.win = NULL,.conform = NULL,.navi = NULL,};
 ...
 */
Evas_Object *
_new_button (Evas_Object * display, char *name, void *callback)
{
 ...
 */
static void
_btn_clear_cb (void *data, Evas_Object * object, void *event_info)
{
...
_create_new_cd_display (char *name, void *callback)
{
  ...
  Elm_Object_Item *item =
      elm_naviframe_item_push (s_info.navi, "MachineLearning",
