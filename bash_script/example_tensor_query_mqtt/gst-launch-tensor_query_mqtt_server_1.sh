...
gst-launch-1.0 \
    tensor_query_serversrc id=123 host=$HOST port=0 dest-host=$DEST_HOST dest-port=1883 topic=objectDetection connect-type=HYBRID ! \
    ...
    videoconvert ! tensor_query_serversink id=123 connect-type=HYBRID
