...
#
# Geunsik Lim <geunsik.lim@samsung.com> & Jijoong Moon <jijoong.moon@samsung.com>
...
# need to build libnnstreamer.so
...
LOCAL_SRC_FILES += ./nnstreamer_android.c
LOCAL_CXXFLAGS  += -std=c++11
LOCAL_LDFLAGS   := $(CUSTOM_LINKER64)

NNSTREAMER_GST_HOME    := /usr/include/nnstreamer
