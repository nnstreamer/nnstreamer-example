...
public class NNStreamerActivity extends Activity implements
    ...
    private native void nativeInit(int w, int h, String path); /* Initialize native code, build pipeline, etc */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /* Get the Intent from FileChooser */
        Intent intent = getIntent();
        String media_path = intent.getStringExtra(FileChooser.EXTRA_MESSAGE);
        initActivity(media_path);
    }
     ...
     */
    private void initActivity(String media_path) {
        if (initialized) {
            return;
        }
        ...
        /* Initialize with media resolution & media path */
        nativeInit(GStreamerSurfaceView.media_width, 
                   GStreamerSurfaceView.media_height, 
                   media_path);
