    ...
    gchar ** files_dir)
{
  ...
  jmethodID get_cache_dir_id, get_files_dir_id, package_code_id;
  ...
  *cache_dir = *files_dir = NULL;
  ...
  package_code_id = (*env)->GetMethodID(env, context_class, "getPackageCodePath","()Ljava/lang/String;");
  ...
  g_setenv("GST_PLUGIN_PATH",path->str,1);
